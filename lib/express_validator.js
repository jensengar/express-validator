...
var expressValidator = function(options) {
  ...
  ValidatorChain.prototype.optionalNil = function(allowEmptyString) {
    this.skipValidating = _.isNil(this.value) || (_.isString(this.value) && !this.value && allowEmptyString);
